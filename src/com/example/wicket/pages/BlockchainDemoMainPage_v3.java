...
public class BlockchainDemoMainPage_v3 extends WebPage {
	...
	public BlockchainDemoMainPage_v3(PageParameters params) {
		super(params);
	}
...
//		assetTransactionContainer.add(getVehicleDetailsLink());
	...
	private Behavior getVehicleOnDropBehavior(final String destination)
	{
		return new AjaxEventBehavior("ondrop")
		{
			...
			protected void onEvent(AjaxRequestTarget target)
			{
				BlockchainDemoMainPage_v3.this.destination = destination;
			}
		};
	}
